"""
download_pines_data.py

Downloads the daily Plant Report XLSX for MP The Pines from the
FusionSolar portal via Playwright.

SITE CONFIG — edit these if the plant name in the FusionSolar portal changes:
  Search term (typed into the Plant name search box): 'The Pines'
  Plant link text to click:                           'MP The Pines'
  Output file:                                        data/pines_raw.xlsx
...
def download_pines_data():
    """Download MP The Pines data from FusionSolar"""

    print("🚀 Starting MP The Pines data download...")
    ...
    with sync_playwright() as playwright:
        ...
        try:
            ...
            # =========================================================
            # Step 6: Search for The Pines
            # Try multiple selector strategies based on inspection
            # =========================================================
            print("🔎 Step 6: Searching for The Pines...")
            ...
            human_delay(1, 2)
            type_human_like(search_field, "The Pines")
            human_delay(2, 3)
            ...
            # =========================================================
            # Step 7: Click MP The Pines
            # =========================================================
            print("🏢 Step 7: Selecting MP The Pines...")
            try:
                page.get_by_role("link", name="MP The Pines").click()
            except:
                # Fallback: find by text
                page.get_by_text("MP The Pines").first.click()

            page.wait_for_load_state("networkidle", timeout=60000)
            human_delay(5, 8)
            random_mouse_movement(page)

            page.screenshot(path="04_pines_station.png", full_page=True)
            ...
            download_path = data_dir / "pines_raw.xlsx"
